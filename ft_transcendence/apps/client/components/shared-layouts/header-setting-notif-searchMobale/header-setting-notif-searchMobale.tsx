...
function HeaderSettingNotifSearchMobale(): JSX.Element {
  ...
  useEffect(() => {
    ...
    document.addEventListener("click", checkIfClickedOutside, {passive: false});
    ...
    document.addEventListener("click", checkIfClickedOutsides, {passive: false});
